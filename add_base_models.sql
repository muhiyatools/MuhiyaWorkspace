...
('model-claude-3-5', 'claude-3-5-sonnet', 'anthropic', 'claude-3-5-sonnet-20241022', 3.00, 15.00, 0.30, 3.75, 'active', 'none', 'llm', 0.0, false),
('model-claude-3-7', 'claude-3-7-sonnet', 'anthropic', 'claude-3-7-sonnet-20250219', 3.00, 15.00, 0.30, 3.75, 'active', 'none', 'llm', 0.0, false),
('model-deepseek-chat', 'deepseek-chat', 'deepseek', 'deepseek-chat', 0.14, 0.28, 0.07, 0.14, 'active', 'none', 'llm', 0.0, false)
ON CONFLICT (id) DO NOTHING;
